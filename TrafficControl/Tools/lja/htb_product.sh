...
tc_set_policy(){
	...
	# manage port -- [1024,0x7FFF] 495mbit~1000mbit class1:20
	# user port    -- [0x8000,0xFFFF] 495mbit~1000mbit class1:30
	...
	local cmdAddClass1_10="tc class add dev $dev parent 1:1 classid 1:10 htb rate $class10_rate ceil $class10_ceil burst 100M cburst 100M quantum 300000"
	...
	local cmdAddClass1_30="tc class add dev $dev parent 1:1 classid 1:30 htb rate $class30_rate ceil $class30_ceil burst 100M cburst 100M quantum 150000"
	local cmdAddLeaf20_0="tc qdisc add dev $dev parent 1:20 handle 20:0 sfq"
	local cmdAddLeaf30_0="tc qdisc add dev $dev parent 1:30 handle 30:0 sfq"
